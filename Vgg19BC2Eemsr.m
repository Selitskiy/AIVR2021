...
nModels = 6;
myNets = [];
save_net_fileT = '/media/data2/vgg_eswarm';
%save_s1net_fileT = '/media/data2/vgg_eswarm1_sv';
save_s2net_fileT = '/media/data2/vgg_eswarm2_sv';
...
t2 = clock();
fprintf('Vgg19 training N images:%d time:%.3f, models %d\n', trainCount, etime(t2, t1), nModels);
...
t2 = clock();
fprintf('Vgg19 Supervisor training N images:%d time:%.3f, models %d\n', nImgsTot, etime(t2, t1), nModels);
...
fd = fopen( strcat('predict_vgg_6bfmsr',int2str(nModels),'.txt'),'w' );
...
fprintf('Vgg19 test N images:%d, models %d\n', nImgsTot, nModels);
