...
[baseSet, dataSetFolder] = createBCbaselineE(dataFolderTmpl, dataFolderSfx, @readFunctionTrain_n);
trainingSet = baseSet;
...
%save_s1net_fileT = '~/data/an_eswarm1_sv';
save_s2net_fileT = '~/data/an_eswarm2_sv';
...
t2 = clock();
fprintf('AlexNet training N images:%d time:%.3f, models %d\n', trainCount, etime(t2, t1), nModels);
...
[testRSets, testRDataSetFolders] = createBCtestE1(dataFolderTmpl, dataFolderSfx, @readFunctionTrain_n);
...
t2 = clock();
fprintf('AlexNet Supervisor training N images:%d time:%.3f, models %d\n', nImgsTot, etime(t2, t1), nModels);
...
[testSets, testDataSetFolders] = createBCtestEe(dataFolderTmpl, dataFolderSfx, @readFunctionTrain_n);
...
fd = fopen( strcat('predict_an_6bfmsr',int2str(nModels),'.txt'),'w' );
...
fprintf('AlexNet test N images:%d, models %d\n', nImgsTot, nModels);
