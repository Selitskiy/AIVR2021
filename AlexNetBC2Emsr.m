...
nModels = 7;
myNets = [];
save_net_fileT = '/media/data2/an_eswarm';
%save_s1net_fileT = '/media/data2/an_eswarm1_sv';
save_s2net_fileT = '/media/data2/an_eswarm2_sv';
...
% Create imageDataset vector of images in selected makeup folders
[testSets, testDataSetFolders] = createBCtestE(dataFolderTmpl, dataFolderSfx, @readFunctionTrain_n);
